...
const Utilities = (() => {
     ...
     * @return {Buffer}
     */
    publicScope.packCommandPayloadIntoFrameBuffer = (commandPayload) => {
     ...
     * @function
     * @param {Buffer} buffer
     * @return {AcceptableFrameRangeArray}
     */
    publicScope.findAcceptableFrameRangesInBuffer = (buffer) => {
     ...
     * @function
     * @param {CommandPayload} commandPayload
     * @param {ResponsePayload[]} responsePayloads
     * @return {boolean}
     */
    publicScope.checkAllResponsePayloadsReceived = (commandPayload, responsePayloads) => {
        const addressType = Addresses.find(commandPayload.address);
