...
/**
 * @typedef AcceptableFrameRangeArray
 * @type {Array<AcceptableFrameRange>}
 */
...
/**
 * @typedef ResponsePayloadArray
 * @type {Array<ResponsePayload>}
 */
 ...
 * @property {Promise<ResponsePayloadArray>} promise
 * @property {(value: ResponsePayloadArray) => void} resolve
 * @property {(reason: any) => void} reject
 * @property {boolean} ended
 * @property {boolean} received
 * @property {NodeJS.Timeout} timeoutTimer
 * @property {any} reason
 * @property {ResponsePayloadArray} responsePayloads
 * @property {() => void} abort
 * @property {(stream: Stream) => void} ping
 * @property {(error: any, responsePayload: ResponsePayload) => void} pong
 * @property {(reason: any, value: any) => void} end
 */
 ...
 * @property {() => Stream} input
 * @property {() => Stream} output
 * @property {(commandPayload: CommandPayload) => Task} enqueue
 */
 ...
 * @property {() => Promise<void>} open
 * @property {() => Promise<void>} close
 * @property {object} memoryDataLong
 * @property {(data: MemoryDataLongReadCommandData) => Promise<MemoryDataLongReadResponseData>} memoryDataLong.read
 * @property {object} memoryDataShort
 * @property {(data: MemoryDataShortReadCommandData) => Promise<MemoryDataShortReadResponseData>} memoryDataShort.read
 * @property {object} latestDataLong
 * @property {(data: LatestDataLongReadCommandData) => Promise<LatestDataLongReadResponseData>} latestDataLong.read
 * @property {object} latestDataShort
 * @property {(data: LatestDataShortReadCommandData) => Promise<LatestDataShortReadResponseData>} latestDataShort.read
 * @property {object} accelerationMemoryDataHeader
 * @property {(data: AccelerationMemoryDataHeaderReadCommandData) => Promise<AccelerationMemoryDataHeaderReadResponseData>} accelerationMemoryDataHeader.read
 * @property {object} accelerationMemoryDataData
 * @property {(data: AccelerationMemoryDataDataReadCommandData) => Promise<AccelerationMemoryDataDataReadResponseData>} accelerationMemoryDataData.read
 * @property {object} latestMemoryInformation
 * @property {(data: LatestMemoryInformationReadCommandData) => Promise<LatestMemoryInformationReadResponseData>} latestMemoryInformation.read
 * @property {object} latestSensingData
 * @property {(data: LatestSensingDataReadCommandData) => Promise<LatestSensingDataReadResponseData>} latestSensingData.read
 * @property {object} latestCalculationData
 * @property {(data: LatestCalculationDataReadCommandData) => Promise<LatestCalculationDataReadResponseData>} latestCalculationData.read
 * @property {object} latestSensingFlag
 * @property {(data: LatestSensingFlagReadCommandData) => Promise<LatestSensingFlagReadResponseData>} latestSensingFlag.read
 * @property {object} latestCalculationFlag
 * @property {(data: LatestCalculationFlagReadCommandData) => Promise<LatestCalculationFlagReadResponseData>} latestCalculationFlag.read
 * @property {object} latestAccelerationStatus
 * @property {(data: LatestAccelerationStatusReadCommandData) => Promise<LatestAccelerationStatusReadResponseData>} latestAccelerationStatus.read
 * @property {object} vibrationCount
 * @property {(data: VibrationCountReadCommandData) => Promise<VibrationCountReadResponseData>} vibrationCount.read
 * @property {object} ledSettingNormalState
 * @property {(data: LedSettingNormalStateReadCommandData) => Promise<LedSettingNormalStateReadResponseData>} ledSettingNormalState.read
 * @property {(data: LedSettingNormalStateWriteCommandData) => Promise<LedSettingNormalStateWriteResponseData>} ledSettingNormalState.write
 * @property {object} ledSettingEventState
 * @property {(data: LedSettingEventStateReadCommandData) => Promise<LedSettingEventStateReadResponseData>} ledSettingEventState.read
 * @property {(data: LedSettingEventStateWriteCommandData) => Promise<LedSettingEventStateWriteResponseData>} ledSettingEventState.write
 * @property {object} ledSettingOperation
 * @property {(data: LedSettingOperationReadCommandData) => Promise<LedSettingOperationReadResponseData>} ledSettingOperation.read
 * @property {(data: LedSettingOperationWriteCommandData) => Promise<LedSettingOperationWriteResponseData>} ledSettingOperation.write
 * @property {object} installationOffset
 * @property {(data: InstallationOffsetReadCommandData) => Promise<InstallationOffsetReadResponseData>} installationOffset.read
 * @property {(data: InstallationOffsetWriteCommandData) => Promise<InstallationOffsetWriteResponseData>} installationOffset.write
 * @property {object} advertiseSetting
 * @property {(data: AdvertiseSettingReadCommandData) => Promise<AdvertiseSettingReadResponseData>} advertiseSetting.read
 * @property {(data: AdvertiseSettingWriteCommandData) => Promise<AdvertiseSettingWriteResponseData>} advertiseSetting.write
 * @property {object} memoryReset
 * @property {(data: MemoryResetWriteCommandData) => Promise<MemoryResetWriteResponseData>} memoryReset.write
 * @property {object} modeChange
 * @property {(data: ModeChangeReadCommandData) => Promise<ModeChangeReadResponseData>} modeChange.read
 * @property {(data: ModeChangeWriteCommandData) => Promise<ModeChangeWriteResponseData>} modeChange.write
 * @property {object} accelerationLoggerControl
 * @property {(data: AccelerationLoggerControlWriteCommandData) => Promise<AccelerationLoggerControlWriteResponseData>} accelerationLoggerControl.write
 * @property {object} accelerationLoggerStatus
 * @property {(data: AccelerationLoggerStatusReadCommandData) => Promise<AccelerationLoggerStatusReadResponseData>} accelerationLoggerStatus.read
 * @property {(data: AccelerationLoggerStatusWriteCommandData) => Promise<AccelerationLoggerStatusWriteResponseData>} accelerationLoggerStatus.write
 * @property {object} latestTimeCounter
 * @property {(data: LatestTimeCounterReadCommandData) => Promise<LatestTimeCounterReadResponseData>} latestTimeCounter.read
 * @property {object} timeSetting
 * @property {(data: TimeSettingReadCommandData) => Promise<TimeSettingReadResponseData>} timeSetting.read
 * @property {(data: TimeSettingWriteCommandData) => Promise<TimeSettingWriteResponseData>} timeSetting.write
 * @property {object} memoryStorageInterval
 * @property {(data: MemoryStorageIntervalReadCommandData) => Promise<MemoryStorageIntervalReadResponseData>} memoryStorageInterval.read
 * @property {(data: MemoryStorageIntervalWriteCommandData) => Promise<MemoryStorageIntervalWriteResponseData>} memoryStorageInterval.write
 * @property {object} eventPatternSensor1
 * @property {(data: EventPatternSensor1ReadCommandData) => Promise<EventPatternSensor1ReadResponseData>} eventPatternSensor1.read
 * @property {(data: EventPatternSensor1WriteCommandData) => Promise<EventPatternSensor1WriteResponseData>} eventPatternSensor1.write
 * @property {object} eventPatternSensor2
 * @property {(data: EventPatternSensor2ReadCommandData) => Promise<EventPatternSensor2ReadResponseData>} eventPatternSensor2.read
 * @property {(data: EventPatternSensor2WriteCommandData) => Promise<EventPatternSensor2WriteResponseData>} eventPatternSensor2.write
 * @property {object} eventPatternAcceleration
 * @property {(data: EventPatternAccelerationReadCommandData) => Promise<EventPatternAccelerationReadResponseData>} eventPatternAcceleration.read
 * @property {(data: EventPatternAccelerationWriteCommandData) => Promise<EventPatternAccelerationWriteResponseData>} eventPatternAcceleration.write
 * @property {object} errorStatus
 * @property {(data: ErrorStatusReadCommandData) => Promise<ErrorStatusReadResponseData>} errorStatus.read
 * @property {object} mountingOrientation
 * @property {(data: MountingOrientationReadCommandData) => Promise<MountingOrientationReadResponseData>} mountingOrientation.read
 * @property {object} deviceInformation
 * @property {(data: DeviceInformationReadCommandData) => Promise<DeviceInformationReadResponseData>} deviceInformation.read
 */
 ...
 * @typedef DataType
 * @property {number} length
 * @property {FieldTypeArray} fieldTypes
 */
 ...
 * @property {(buffer: Buffer, begin: number, end: number) => (number | bigint | string)} read
 * @property {(buffer: Buffer, begin: number, end: number, value: (number | bigint | string)) => number} write
 ...
 * @typedef ContentType
 * @type {object}
 * @property {ContentName} name
 * @property {(value: any) => any} encode
 * @property {(value: any) => any} decode
 */

/**
 * @typedef ContentTypeArray
 * @type {Array<ContentType>}
 */

/**
 * @typedef ContentTypeMap
 * @type {Map<ContentName, ContentType>}
 */

/**
 * @typedef Contents
 * @type {object}
 * @property {(value: ContentName) => ContentType} find
 */
 ...
 * @typedef Task
 * @type {object}
 * @property {Promise<ResponsePayload>} promise
 * @property {(value: ResponsePayload) => void} resolve
 * @property {(reason: any) => void} reject
 * @property {boolean} ended
 * @property {NodeJS.Timeout} timeoutTimer
 * @property {Array<ResponsePayload>} responsePayloads
 * @property {() => void} ping
 * @property {(error: any, responsePayload: ResponsePayload) => void} pong
 * @property {() => void} cancel
 * @property {(error: any, value: any) => void} end
 *
 *
 *
 * @property {CommandPayload} commandPayload
 ...
 * @property {() => Stream} input
 * @property {() => Stream} output
 * @property {(input: CommandPayload) => Task} enqueue
 */
