...
const Controller = (options) => {
    ...
    publicScope.open = async () => {
        if (privateScope.channel == null) {
            privateScope.channel = Channel({ path: options.path });
    ...
    publicScope.close = async () => {
        if (privateScope.queue != null) {
            if (privateScope.reader != null) {
                privateScope.reader.output().unpipe(privateScope.queue.input());
            }
            if (privateScope.writer != null) {
    ...
    publicScope.memoryDataLong = {
         ...
         */
        read: (data) => {
            return privateScope.execute({ command: 'read', address: 'memoryDataLong', data }).then((responsePayload) => responsePayload.data);
        },
    };
    ...
    publicScope.memoryDataShort = {
         ...
         */
        read: (data) => {
            return privateScope.execute({ command: 'read', address: 'memoryDataShort', data }).then((responsePayload) => responsePayload.data);
        },
    };
    ...
    publicScope.latestDataLong = {
         ...
         */
        read: (data) => {
            return privateScope.execute({ command: 'read', address: 'latestDataLong', data }).then((responsePayload) => responsePayload.data);
        },
    };
    ...
    publicScope.latestDataShort = {
         ...
         */
        read: (data) => {
            return privateScope.execute({ command: 'read', address: 'latestDataShort', data }).then((responsePayload) => responsePayload.data);
        },
    };
    ...
    publicScope.accelerationMemoryDataHeader = {
         ...
         */
        read: (data) => {
            return privateScope.execute({ command: 'read', address: 'accelerationMemoryDataHeader', data }).then((responsePayload) => responsePayload.data);
        },
    };
    ...
    publicScope.accelerationMemoryDataData = {
         ...
         */
        read: (data) => {
            return privateScope.execute({ command: 'read', address: 'accelerationMemoryDataData', data }).then((responsePayload) => responsePayload.data);
        },
    };
    ...
    publicScope.latestMemoryInformation = {
         ...
         */
        read: (data) => {
            return privateScope.execute({ command: 'read', address: 'latestMemoryInformation', data }).then((responsePayload) => responsePayload.data);
        },
    };
    ...
    publicScope.latestSensingData = {
         ...
         */
        read: (data) => {
            return privateScope.execute({ command: 'read', address: 'latestSensingData', data }).then((responsePayload) => responsePayload.data);
        },
    };
    ...
    publicScope.latestCalculationData = {
         ...
         */
        read: (data) => {
            return privateScope.execute({ command: 'read', address: 'latestCalculationData', data }).then((responsePayload) => responsePayload.data);
        },
    };
    ...
    publicScope.latestSensingFlag = {
         ...
         */
        read: (data) => {
            return privateScope.execute({ command: 'read', address: 'latestSensingFlag', data }).then((responsePayload) => responsePayload.data);
        },
    };
    ...
    publicScope.latestCalculationFlag = {
         ...
         */
        read: (data) => {
            return privateScope.execute({ command: 'read', address: 'latestCalculationFlag', data }).then((responsePayload) => responsePayload.data);
        },
    };
    ...
    publicScope.latestAccelerationStatus = {
         ...
         */
        read: (data) => {
            return privateScope.execute({ command: 'read', address: 'latestAccelerationStatus', data }).then((responsePayload) => responsePayload.data);
        },
    };
    ...
    publicScope.vibrationCount = {
         ...
         */
        read: (data) => {
            return privateScope.execute({ command: 'read', address: 'vibrationCount', data }).then((responsePayload) => responsePayload.data);
        },
    };
    ...
    publicScope.ledSettingNormalState = {
         ...
         */
        read: (data) => {
            return privateScope.execute({ command: 'read', address: 'ledSettingNormalState', data }).then((responsePayload) => responsePayload.data);
        },
        /**
         * @public
         * @function
         ...
         */
        write: (data) => {
            return privateScope.execute({ command: 'write', address: 'ledSettingNormalState', data }).then((responsePayload) => responsePayload.data);
        },
    };
    ...
    publicScope.ledSettingEventState = {
         ...
         */
        read: (data) => {
            return privateScope.execute({ command: 'read', address: 'ledSettingEventState', data }).then((responsePayload) => responsePayload.data);
        },
        /**
         * @public
         * @function
         ...
         */
        write: (data) => {
            return privateScope.execute({ command: 'write', address: 'ledSettingEventState', data }).then((responsePayload) => responsePayload.data);
        },
    };
    ...
    publicScope.ledSettingOperation = {
         ...
         */
        read: (data) => {
            return privateScope.execute({ command: 'read', address: 'ledSettingOperation', data }).then((responsePayload) => responsePayload.data);
        },
        /**
         * @public
         * @function
         ...
         */
        write: (data) => {
            return privateScope.execute({ command: 'write', address: 'ledSettingOperation', data }).then((responsePayload) => responsePayload.data);
        },
    };
    ...
    publicScope.installationOffset = {
         ...
         */
        read: (data) => {
            return privateScope.execute({ command: 'read', address: 'installationOffset', data }).then((responsePayload) => responsePayload.data);
        },
        /**
         * @public
         * @function
         ...
         */
        write: (data) => {
            return privateScope.execute({ command: 'write', address: 'installationOffset', data }).then((responsePayload) => responsePayload.data);
        },
    };
    ...
    publicScope.advertiseSetting = {
         ...
         */
        read: (data) => {
            return privateScope.execute({ command: 'read', address: 'advertiseSetting', data }).then((responsePayload) => responsePayload.data);
        },
        /**
         * @public
         * @function
         ...
         */
        write: (data) => {
            return privateScope.execute({ command: 'write', address: 'advertiseSetting', data }).then((responsePayload) => responsePayload.data);
        },
    };
    ...
    publicScope.memoryReset = {
         ...
         */
        write: (data) => {
            return privateScope.execute({ command: 'write', address: 'memoryReset', data }).then((responsePayload) => responsePayload.data);
        },
    };
    ...
    publicScope.modeChange = {
         ...
         */
        read: (data) => {
            return privateScope.execute({ command: 'read', address: 'modeChange', data }).then((responsePayload) => responsePayload.data);
        },
        /**
         * @public
         * @function
         ...
         */
        write: (data) => {
            return privateScope.execute({ command: 'write', address: 'modeChange', data }).then((responsePayload) => responsePayload.data);
        },
    };
    ...
    publicScope.accelerationLoggerControl = {
         ...
         */
        write: (data) => {
            return privateScope.execute({ command: 'write', address: 'accelerationLoggerControl', data }).then((responsePayload) => responsePayload.data);
        },
    };
    ...
    publicScope.accelerationLoggerStatus = {
         ...
         */
        read: (data) => {
            return privateScope.execute({ command: 'read', address: 'accelerationLoggerStatus', data }).then((responsePayload) => responsePayload.data);
        },
        /**
         * @public
         * @function
         ...
         */
        write: (data) => {
            return privateScope.execute({ command: 'write', address: 'accelerationLoggerStatus', data }).then((responsePayload) => responsePayload.data);
        },
    };
    ...
    publicScope.latestTimeCounter = {
         ...
         */
        read: (data) => {
            return privateScope.execute({ command: 'read', address: 'latestTimeCounter', data }).then((responsePayload) => responsePayload.data);
        },
    };
    ...
    publicScope.timeSetting = {
         ...
         */
        read: (data) => {
            return privateScope.execute({ command: 'read', address: 'timeSetting', data }).then((responsePayload) => responsePayload.data);
        },
        /**
         * @public
         * @function
         ...
         */
        write: (data) => {
            return privateScope.execute({ command: 'write', address: 'timeSetting', data }).then((responsePayload) => responsePayload.data);
        },
    };
    ...
    publicScope.memoryStorageInterval = {
         ...
         */
        read: (data) => {
            return privateScope.execute({ command: 'read', address: 'memoryStorageInterval', data }).then((responsePayload) => responsePayload.data);
        },
        /**
         * @public
         * @function
         ...
         */
        write: (data) => {
            return privateScope.execute({ command: 'write', address: 'memoryStorageInterval', data }).then((responsePayload) => responsePayload.data);
        },
    };
    ...
    publicScope.eventPatternSensor1 = {
         ...
         */
        read: (data) => {
            return privateScope.execute({ command: 'read', address: 'eventPatternSensor1', data }).then((responsePayload) => responsePayload.data);
        },
        /**
         * @public
         * @function
         ...
         */
        write: (data) => {
            return privateScope.execute({ command: 'write', address: 'eventPatternSensor1', data }).then((responsePayload) => responsePayload.data);
        },
    };
    ...
    publicScope.eventPatternSensor2 = {
         ...
         */
        read: (data) => {
            return privateScope.execute({ command: 'read', address: 'eventPatternSensor2', data }).then((responsePayload) => responsePayload.data);
        },
        /**
         * @public
         * @function
         ...
         */
        write: (data) => {
            return privateScope.execute({ command: 'write', address: 'eventPatternSensor2', data }).then((responsePayload) => responsePayload.data);
        },
    };
    ...
    publicScope.eventPatternAcceleration = {
         ...
         */
        read: (data) => {
            return privateScope.execute({ command: 'read', address: 'eventPatternAcceleration', data }).then((responsePayload) => responsePayload.data);
        },
        /**
         * @public
         * @function
         ...
         */
        write: (data) => {
            return privateScope.execute({ command: 'write', address: 'eventPatternAcceleration', data }).then((responsePayload) => responsePayload.data);
        },
    };
    ...
    publicScope.errorStatus = {
         ...
         */
        read: (data) => {
            return privateScope.execute({ command: 'read', address: 'errorStatus', data }).then((responsePayload) => responsePayload.data);
        },
    };
    ...
    publicScope.mountingOrientation = {
         ...
         */
        read: (data) => {
            return privateScope.execute({ command: 'read', address: 'mountingOrientation', data }).then((responsePayload) => responsePayload.data);
        },
    };
    ...
    publicScope.deviceInformation = {
         ...
         */
        read: (data) => {
            return privateScope.execute({ command: 'read', address: 'deviceInformation', data }).then((responsePayload) => responsePayload.data);
        },
    };
